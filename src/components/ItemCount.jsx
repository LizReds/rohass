...
const ItemCount = ({saveItems})=> {
    ...
    const getCartItems = () => {
        saveItems({id:itemId, quantity:counter})
    }
    ...
    return (
            ...
            <div className="flex-wrap text-center text-green-600 text-lg mx-24 font-bold py-2 px-32">
                ...
                <br></br>
                {itemVerification &&  <button className="text-base font-semibold text-white m-5 p-1 w-40 rounded bg-green-500 hover:bg-green-600 " onClick={getCartItems}>Agregar al carrito</button>}
            </div>
